...
function PrivacySection() {
  return (
    <section className="privacy-tos-section">
      ...
      We track websites you visit within the extension so that we can find the appropriate Twitter handle. Whenever you click the extension, a secure HTTPS request is made to our server. No personally identifying information is sent in that request that could tie back to you and no record is made of your having visited the site on our server.
      ...
      <p>If ownership of all or substantially all of our business changes, or we undertake a corporate reorganization (including merger or consolidation) or any other action or transfer between More Human Internet entities, you expressly consent to More Human Internet transferring your information to the new owner or successor entity so that we can continue providing our services. If required, More Human Internet will notify the applicable data protection agency in each jurisdiction of such a transfer in accordance with the notification procedures under applicable data protection laws.</p>
