...
function TosSection() {
  return (
    <div className="privacy-tos-section">
      ...
      <p>The Agreements (and any non-contractual disputes / claims arising out of or in connection with them) are subject to the laws of the state of Delaware, United States of America, without regard to choice or conflicts of law principles.</p>
